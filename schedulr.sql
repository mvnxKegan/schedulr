...
--
-- Dumping data for table `ccp_banner_category`
--

INSERT INTO `ccp_banner_category` (`_id`, `_order_by`, `view_id`, `title`, `description`) VALUES
(1, NULL, 1, 'Home Page Banner', NULL);
...
--
-- Dumping data for table `ccp_banner_item`
--

INSERT INTO `ccp_banner_item` (`_id`, `_category_id`, `title`, `sub_title`, `content`, `image`) VALUES
(1, 1, 'Welcome to pluton theme', 'Clean & responsive', '<p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane.</p>\r\n<a href="#" class="da-link button">Read more</a>\r\n', 'engine/template/web/images/Slider01.png'),
(2, 1, 'Easy management', 'Easy to use', '<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>\r\n<a href="#" class="da-link button">Read more</a>\r\n', 'engine/template/web/images/Slider02.png'),
(3, 1, 'Revolution', 'Customizable', '<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>\r\n<a href="#" class="da-link button">Read more</a>', 'engine/template/web/images/Slider03.png');
...
INSERT INTO `ccp_content_items` (`_id`, `_category_id`, `title`, `content`, `image`) VALUES
...
(10, 2, 'Modern Design', '<h3>Modern Design</h3>\r\n<p>We Create Modern And Clean Theme For Your Business Company.</p>\r\n', 'engine/template/web/images/Service1.png'),
(11, 2, 'Powerfull Theme', '<h3>Powerfull Theme</h3>\r\n<p>We Create Modern And Powerful Theme With Lots Animation And Features</p>', 'engine/template/web/images/Service2.png'),
(12, 2, 'Clean Code', '<h3>Clean Code</h3>\r\n<p>We Create Modern And Powerful Html5 And CSS3 Code Easy For Read And Customize.</p>\r\n', 'engine/template/web/images/Service3.png');
...
--
-- Dumping data for table `ccp_views_table`
--
...
--
-- Dumping data for table `ccp_view_category`
--

INSERT INTO `ccp_view_category` (`_id`, `_parent_id`, `title`, `description`) VALUES
(1, NULL, 'Default Banner', NULL);
...
--
-- AUTO_INCREMENT for table `ccp_banner_category`
--
ALTER TABLE `ccp_banner_category`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ccp_banner_item`
--
ALTER TABLE `ccp_banner_item`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `ccp_blog_category`
--
ALTER TABLE `ccp_blog_category`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ccp_blog_item`
--
ALTER TABLE `ccp_blog_item`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ccp_content_category`
--
ALTER TABLE `ccp_content_category`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ccp_content_items`
--
ALTER TABLE `ccp_content_items`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `ccp_email_templates`
--
ALTER TABLE `ccp_email_templates`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ccp_email_template_category`
--
ALTER TABLE `ccp_email_template_category`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `ccp_form_category`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ccp_form_template`
--
ALTER TABLE `ccp_form_template`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `ccp_style_design`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ccp_template`
--
ALTER TABLE `ccp_template`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
